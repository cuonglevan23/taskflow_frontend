...
interface CustomGoogleCalendarIconProps {
  size?: number;
  className?: string;
  color?: string;
}

const CustomGoogleCalendarIcon: React.FC<CustomGoogleCalendarIconProps> = ({
  size = 24,
  className = '',
  color = 'currentColor'
}) => {
    ...
    >
      ...
      <g id="SVGRepo_iconCarrier">
        ...
        <rect
          fill="#00ac47"
          height="12"
          transform="translate(40.5 8.5) rotate(90)"
          width="6"
          x="13"
          y="18.5"
        />
...
export default CustomGoogleCalendarIcon;
