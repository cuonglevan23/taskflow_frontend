  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      >
        {/* Header */}
        <div
          className="absolute top-0 left-0 right-0 z-10 flex items-center justify-between p-6 border-b"
          style={{
                ...
                <div className="max-w-2xl space-y-8">
                  ...
                  <div>
                    ...
                    <p
                      ...
                      style={{ color: theme.text.secondary }}
                    >
                      This helps us tailor Asana for you, and we may reach out
            ...
            >
              ...
              <div>
                <div className="flex items-center justify-between mb-4">
                  ...
                  <button className="text-blue-600 text-sm">Create goal</button>
                </div>
